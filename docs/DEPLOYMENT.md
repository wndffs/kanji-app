...
2. Apply database migrations and seed starter content from a trusted local
   machine:
...
3. Create the Render API service from `render.yaml`.
...
4. Create the Vercel web project from the same GitHub repository.
...
5. If either generated URL differs from the planned value, update the paired
